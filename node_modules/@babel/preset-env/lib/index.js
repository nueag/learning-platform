...
var _debug = require("@babel/preset-env/lib/debug");

var _getOptionSpecificExcludes = require("@babel/preset-env/lib/get-option-specific-excludes");
...
var _shippedProposals = require("@babel/preset-env/data/shipped-proposals");

var _pluginsCompatData = require("@babel/preset-env/lib/plugins-compat-data");

var _overlappingPlugins = require("@babel/compat-data/overlapping-plugins");

var _regenerator = require("@babel/preset-env/lib/polyfills/regenerator");

var _babelPolyfill = require("@babel/preset-env/lib/polyfills/babel-polyfill");
...
var _availablePlugins = require("@babel/preset-env/lib/available-plugins");
